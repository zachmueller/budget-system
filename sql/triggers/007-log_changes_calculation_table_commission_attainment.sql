...
IF OBJECT_ID('dbo.log_changes_calculation_table_commission_attainment', 'TR') IS NOT NULL
	DROP TRIGGER dbo.log_changes_calculation_table_commission_attainment
GO


CREATE TRIGGER dbo.log_changes_calculation_table_commission_attainment
	ON BudgetDB.dbo.calculation_table_commission_attainment
...
SELECT @@SPID, @ci, COUNT(*), SYSTEM_USER
	,GETDATE(), 'calculation_table_commission_attainment', APP_NAME(), action_taken
FROM (
	...
	AND d.workbook_id=i.workbook_id
	UNION ALL
