...
IF TYPE_ID('dbo.bulk_upload_base_bonus') IS NOT NULL
	DROP TYPE dbo.bulk_upload_base_bonus
GO


CREATE TYPE dbo.bulk_upload_base_bonus AS TABLE(
	...
	avg_base DECIMAL(30, 16) NULL,
	avg_bonus DECIMAL(20, 18) NULL,
	avg_commission DECIMAL(20, 18) NULL,
...
summary:	>
			...
			to push into the relevant calculation tables that
			maintain the current assumptions for Average Base,
			Bonus, and Commissions for each role.
Revisions:
- version 1:
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TYPE'
	,@level1name = N'bulk_upload_base_bonus';
