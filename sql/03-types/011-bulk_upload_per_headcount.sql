...
IF TYPE_ID('dbo.bulk_upload_per_headcount') IS NOT NULL
	DROP TYPE dbo.bulk_upload_per_headcount
GO


CREATE TYPE dbo.bulk_upload_per_headcount AS TABLE(
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TYPE'
	,@level1name = N'bulk_upload_per_headcount';
