...
IF TYPE_ID('dbo.settings_upload_products') IS NOT NULL
	DROP TYPE dbo.settings_upload_products
GO


CREATE TYPE dbo.settings_upload_products AS TABLE(
...
summary:	>
			...
			changes to the dbo.products table.
Revisions:
- version 1:
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TYPE'
	,@level1name = N'settings_upload_products';
