...
IF OBJECT_ID('dbo.calculation_table_base', 'U') IS NOT NULL
	DROP TABLE dbo.calculation_table_bonus_payout_pct
GO


CREATE TABLE dbo.calculation_table_bonus_payout_pct (
	scenario_id INT NOT NULL
		CONSTRAINT fk_calculation_table_bonus_payout_pct_scenario_id FOREIGN KEY
	...
	CONSTRAINT pk_calculation_table_bonus_payout_pct
...
summary:	>
			...
			assumptions for company bonus payout
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TABLE'
	,@level1name = N'calculation_table_bonus_payout_pct';
