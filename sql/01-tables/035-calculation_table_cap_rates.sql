...
IF OBJECT_ID('dbo.calculation_table_cap_rates', 'U') IS NOT NULL
	DROP TABLE dbo.calculation_table_cap_rates
GO


CREATE TABLE dbo.calculation_table_cap_rates (
	id INT NOT NULL
		CONSTRAINT fk_calculation_table_cap_rates_id FOREIGN KEY
		REFERENCES dbo.live_forecast (id),
	...
	CONSTRAINT pk_calculation_table_cap_rates
...
EXEC sys.sp_addextendedproperty @name = N'Documentation'
	,@value = N'
summary:	>
			Table that maintains current assumptions
			for capitalization rates that point directly
			to individual records in dbo.live_forecast.
Revisions:
- version 1:
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TABLE'
	,@level1name = N'calculation_table_cap_rates';
...
EXEC sys.sp_addextendedproperty @name = N'Documentation'
	,@value = N'
summary:	>
			Foreign key to dbo.live_forecast to
