...
IF TYPE_ID('dbo.bulk_upload_expense_payroll_taxes') IS NOT NULL
	DROP TYPE dbo.bulk_upload_expense_payroll_taxes
GO


CREATE TYPE dbo.bulk_upload_expense_payroll_taxes AS TABLE(
...
summary:	>
			...
			payroll taxes for employee benefit expenses.
Revisions:
- version 1:
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TYPE'
	,@level1name = N'bulk_upload_expense_payroll_taxes';
