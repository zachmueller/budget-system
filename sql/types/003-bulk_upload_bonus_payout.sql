...
IF TYPE_ID('dbo.bulk_upload_bonus_payout') IS NOT NULL
	DROP TYPE dbo.bulk_upload_bonus_payout
GO


CREATE TYPE dbo.bulk_upload_bonus_payout AS TABLE(
...
summary:	>
			...
			maintains the current assumptions for the Bonus
			Payout percentage.
Revisions:
- version 1:
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TYPE'
	,@level1name = N'bulk_upload_bonus_payout';
