...
IF TYPE_ID('dbo.bulk_upload_percent_of_base') IS NOT NULL
	DROP TYPE dbo.bulk_upload_percent_of_base
GO


CREATE TYPE dbo.bulk_upload_percent_of_base AS TABLE(
...
summary:	>
			...
			expense assumptions as a percent of base salaries.
Revisions:
- version 1:
...
'
	...
	,@level0name = N'dbo'
	,@level1type = N'TYPE'
	,@level1name = N'bulk_upload_percent_of_base';
