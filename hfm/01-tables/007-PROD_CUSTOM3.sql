...
IF OBJECT_ID('dbo.PROD_CUSTOM3', 'U') IS NOT NULL
	DROP TABLE dbo.PROD_CUSTOM3
GO


CREATE TABLE dbo.PROD_CUSTOM3 (
	[ID] INT NOT NULL,
...
summary:	>
			...
			about the CUSTOM3 dimension. The
