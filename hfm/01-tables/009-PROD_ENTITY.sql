...
IF OBJECT_ID('dbo.PROD_ENTITY', 'U') IS NOT NULL
	DROP TABLE dbo.PROD_ENTITY
GO


CREATE TABLE dbo.PROD_ENTITY (
	[ID] INT NOT NULL,
...
summary:	>
			...
			about the ENTITY dimension. The
