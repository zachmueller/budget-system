...
IF OBJECT_ID('dbo.PROD_SCENARIO', 'U') IS NOT NULL
	DROP TABLE dbo.PROD_SCENARIO
GO


CREATE TABLE dbo.PROD_SCENARIO (
	[ID] INT NOT NULL,
...
summary:	>
			...
			about the SCENARIO dimension. The
