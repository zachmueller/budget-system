...
IF OBJECT_ID('dbo.PROD_CUSTOM4', 'U') IS NOT NULL
	DROP TABLE dbo.PROD_CUSTOM4
GO


CREATE TABLE dbo.PROD_CUSTOM4 (
	[ID] INT NOT NULL,
...
summary:	>
			...
			about the CUSTOM4 dimension. The
