...
IF OBJECT_ID('dbo.PROD_CUSTOM1', 'U') IS NOT NULL
	DROP TABLE dbo.PROD_CUSTOM1
GO


CREATE TABLE dbo.PROD_CUSTOM1 (
	[ID] INT NOT NULL,
...
summary:	>
			...
			about the CUSTOM1 dimension. The
